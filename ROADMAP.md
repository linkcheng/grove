...
| WS-8 | Production Release Proof | draft | not_started | WS-7 | 承接原 WS-7 的安全/性能/发布治理义务：G4 安全全矩阵、PITR 全矩阵、Role 故障/扩缩容矩阵、30 天等效容量、POC-H Evaluation/Publication、外部 issuer ceremony、Core/Product IAR、bounded rollout/rollback | [任务书](docs/work-packages/WS-8-production-release-proof.md) |
